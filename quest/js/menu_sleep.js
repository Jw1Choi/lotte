...
<nav class="top">
    ...
    <!--  <p class="logo-font" style="font-size:11px;">롯데장기렌트카 </p> -->
       <img alt="" src="../quest/img/logo.png" ><span class="blink" style="padding-left:8px;font-size:10px;white-space:nowrap">[오늘의 이벤트]</span>
