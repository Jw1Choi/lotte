...
<a href="#" onclick="javascript:OnSubmit();">
 <span style="color:#fff">신청하기</span>
			  ...
			  <form action="" id="form_e11" method="POST" target ="hidden_iframe11" onsubmit=" submitted=true;"> 
			  	<input type="hidden" name="entry.272078534" value="type2">
					<div class="wow fadeIn bbackg"> 
							 ...
							 <section  id="main_intro" class="backg container1" style="text-align: center;" >
							...
							<!-- <center>  <span class="timer " style="border:1px solid #ebebeb !important;padding:8px 15px;font-size:13px;border-radius:16px; ">
						   실시간 특가 | <span class="today_date2"></span> ( <span id="countdown5"></span>)</center><br> -->
					   ...
					   <span class="alert"  id="alert_41">　</span>
						  ...
						  <!--질문0번 SECTION-->	
						  <section  id="quest0_wrap" class="wow fadeIn backg container1" style="min-height:460px;max-height:500px;background:#000;">
					  ...
					  <center><h1><span class="questm ft-white">구입 유형</span></h1></center><br>
					  <center><input id="rent_1" name="entry.1881318671" type="radio" value="장기렌트" /> <label class="label_button1 rent" for="rent_1" onclick="rent_check();jump_quest(1);" >장기렌트</label></center>
					  
					  <center><input id="ls_2" name="entry.1881318671" type="radio" value="신차리스" /> <label class="label_button1 rent" for="ls_2" onclick="lease_check();jump_quest(1);" >신차리스</label></center>
						  ...
						  <!--질문 클릭 시 진행 방향 함수-->
							 ...
							 <!--질문 클릭 시 진행 방향 함수-->
								 ...
								 <section  id="quest1_wrap" class="wow fadeIn backg container1" style="min-height:460px;max-height:500px;background:#000;>
							  ...
							  <center><h1><span class="questm ft-white">구입 유형</span></h1></center><br>
							  <center><input id="mf_1" name="entry.1818522882" type="radio" value="개인" /> <label class="label_button1 female" for="mf_1" onclick="jump_quest(5)" >개인</label></center>
							  
							  <center><input id="mf_2" name="entry.1818522882" type="radio" value="개인사업자" /> <label class="label_button1 female" for="mf_2" onclick="jump_quest(5)" >개인사업자</label></center>
							 
							  <center><input id="mf_3" name="entry.1818522882" type="radio" value="법인" /> <label class="label_button1 female" for="mf_3" onclick="jump_quest(5)" >법인</label></center>
							  ...
							  <!--질문2 SECTION 시작-->
							  <section  id="quest2_wrap" class="wow fadeIn backg " style="background:#000;min-height:910px;max-height:950px;">
								  
								  <!--'이전으로' 버튼 부분-->
							  
							<!-- <img src="./img/mirror.jpg" class="bg-img br50" style="min-height:760px;max-height:800px;"> -->
								 
							  <div class="wow fadeIn img-text ft-white">	
		
							  <center>  <span class="timer " style="border:1px solid #ebebeb;padding:8px 15px;font-size:13px;border-radius:16px; ">
							  실시간 특가 | <span class="today_date2"></span> ( <span id="countdown5"></span>)</center><br>
						  
						  </span>
							<center><h1><span class="questm ft-white">1분 입력으로 간단하게<br>출고 가능 여부와 원하는 차종의<br>특가 정보 받아가세요.<br><br>원하는 차종</span></h1></center>
		
						  <!--질문 문구 부분 시작-->
						  <input name="entry.880528237" class="test_input bb-white"  type="text"  id="now-weight" style="width:100%;text-align:center;" maxlength="10" oninput="maxLengthCheck(this)"  onkeyup="car_name()" placeholder="차종 입력"><label class="ft-white" ></label><br><br>
	...
	<!-- 	<center> <div class=" alert_msg">
		 ...
		 <span class="txt-tip ">차종에 따른<br>출고 가능 여부를 분석합니다.</span><br><br>	
		 </div>
	 ...
	 <!-- end chat -->
		...
		<label class="label_button1 disabled" id="next_nw" for="quest2_1" style="text-align:Center;" onclick="go_height()">다음</label></center><br>	
	  ...
	  <Br>
													<div class="wrap linkWrap" style="display:inline-block;width:85%;">
													<div class="sec00 contents" >
													  <div class="inner" style="text-align:-webkit-center;">
													  <p>
														<span class="today_date1"></span><br>
														현재 <span  class="counter" style="bottom:1px;">142</span> 명이 신청 현황
															...
															<div id="ticker_wrap" style="position: absolute;top:0px;right:0px;width:100%;">
															  ...
															  <tbody>
																<tr>
																  ...
																  <td class="tg-02ax">장기렌트 / 개인</td>
																  <td class="tg-03ax"><span class="submit_03">신청완료</span></td>
																</tr>
																<tr>
																  <td class="tg-0lax"><span class="submit_02">카니발</span></td>
																  <td class="tg-02ax">신차리스 / 개인</td>
																  <td class="tg-03ax"><span class="submit_03">신청완료</span></td>
																</tr>
																<tr>
																  <td class="tg-0lax"><span class="submit_02">레이</span></td>
																  <td class="tg-02ax">장기렌트 / 법인</td>
																  <td class="tg-03ax"><span class="submit_03">신청완료</span></td>
																</tr>
																<tr>
																  <td class="tg-0lax"><span class="submit_02">스포티지</span></td>
																  <td class="tg-02ax">장기렌트 / 개인</td>
																  <td class="tg-03ax"><span class="submit_03">신청완료</span></td>
																</tr>
																<tr>
																  <td class="tg-0lax"><span class="submit_02">제네시스</span></td>
																  <td class="tg-02ax">신차리스 / 개인</td>
																  <td class="tg-03ax"><span class="submit_03">신청완료</span></td>
																</tr>
																<tr>
																  <td class="tg-0lax"><span class="submit_02">벤츠 S 시리즈</span></td>
																  <td class="tg-02ax">신차리스 / 법인</td>
																  <td class="tg-03ax"><span class="submit_03">신청완료</span></td>
																</tr>
																<tr>
																  <td class="tg-0lax"><span class="submit_02">소나타</span></td>
																  <td class="tg-02ax">장기렌트 / 개인</td>
																  <td class="tg-03ax"><span class="submit_03">신청완료</span></td>
																</tr>
																<tr>
																  <td class="tg-0lax"><span class="submit_02">K5</span></td>
																  <td class="tg-02ax">장기렌트 / 법인</td>
																  <td class="tg-03ax"><span class="submit_03">신청완료</span></td>
																</tr>
																<tr>
																  <td class="tg-0lax"><span class="submit_02">포터</span></td>
																  <td class="tg-02ax">장기렌트 / 법인</td>
																  <td class="tg-03ax"><span class="submit_03">신청완료</span></td>
																</tr>
															  </tbody>
							  ...
							  <!--질문2 SECTION 끝-->
								 ...
								 <div class="stepper-item"></div>
											 ...
											 <div class="wow fadeIn img-text ft-white">	
											 <!--질문 문구 부분 시작-->
											 <center><h1><span class="questm ft-white">사업자 / 법인 번호</span></h1></center>
											 
											 <!--질문을 띄어쓰기 하려면 '<br>'을 적으시면 됩니다-->
											 <input name="entry.1300040200" class="test_input bb-white"  type="number"  id="now-height" style="width:40%;text-align:center;" maxlength="3" oninput="maxLengthCheck(this)"  onkeyup="now_height()"><label class="ft-white" >cm</label><br><br>
											 <!--질문 문구 부분 끝-->
						 ...
						 <section  id="quest4_wrap" class="wow fadeIn backg container1" >	
						  ...
						  <div class="wow fadeIn img-text ft-white">	
							  ...
							  <section  id="quest5_wrap" class="wow fadeIn backg container1" style="min-height:460px;max-height:500px;background:#000;">
							  <!-- <img src="./img/mirror.jpg" class="bg-img br50" style="min-height:460px;max-height:500px"> -->
						  ...
						  <div class="wow fadeIn img-text ft-white">	
							  <center><h1><span class="questm ft-white">성함</span></h1></center>
										 ...
										 <br><br>
										  <!--질문 문구 부분 끝-->
										  <span class="alert" id="alert_name">　</span><br><br><br>
							  ...
							  <!-- 다른 번호의 SECTION 끝 -->
								  ...
								  <section  id="quest6_wrap" class="wow fadeIn backg container1" style="min-height:500px;max-height:550px;background:#000;">
									 <!-- <img src="./img/mirror.jpg" class="bg-img br50" style="min-height:500px;max-height:550px"> -->
									  ...
									  <div class="wow fadeIn img-text ft-white">	
										  ...
										  <label class="label_button1 disabled" id="next_phone" for="quest6_1" style="text-align:Center;" onclick="go_result();">간편 조회 하기</label></center>	
						 ...
						 <section  id="quest100_wrap" class="wow fadeIn backg container1" style="min-height:660px;max-height:700px;background:#000;">
						  
						 <!-- <img src="./img/mirror.jpg" class="bg-img br50" style="min-height:1460px;max-height:1300px"> -->
   
						 <div class="wow fadeIn img-text ft-white">	
				
						 <center><h1 style="line-height:90%"><span class="questm ft-white">롯데장기렌트<br>간편 조회 신청이 완료 되었습니다.<br><br>실질적인 도움과 안내를 위하여<br>전화를 통해 안내를 드리고 있습니다.<br>다만 부재시 감량을 도와드리지 못하니<br>꼭 전화를 받아주세요.<br><br>-롯데렌트리스-</span></h1>
						  ...
						  <div class="footer-top">
							<div class="container">
							  <div class="row">
									...
									<span>롯데렌터카 대표이사 최진환</span><br>
								  <span>사업자등록번호 214-87-79183</span><br>
								  <span>통신판매업신고번호 : 제2010-경기안양-420호</span><br>
								  <span>주소: 경기도 안양시 동안구 전파로 88 신원비젼타워 8층</span><br><span>서울본사: 서울시 강남구 테헤란로 422 KT타워 6~9층</span><br>
