$(document).ready(function(){
    $('#send_message').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e11').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLSdSePBdBiit8SDd478IU6KNuJEFbhkOa_2fXn1vsNIXl4tElg/formResponse");
...
function hoa(){
    ...
    $(window).scrollTop(0);
    window.location.href="./광고집행-기획.html";
