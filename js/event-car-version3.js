...
<div class="inner">
   ...
   <img src="./img/logo.png" style="width:250px">
        <h1 class="wow fadeInUp"><span style="color:yellow;">오늘의 이벤트 차량</span><br>최소 월 렌탈료 및<br>출고 승인 여부<br>확인하세요</h1><br>
    ...
    <ul class="listWrap">
        ...
        <li class="wow fadeInUp" data-wow-delay=".2s">
            <div>
                현재 페이지 한정<br>
                <span class="num blink">추가할인</span>
            </div>
        </li>
    </ul>
...
<div class="sec02 contents">
    <ul class="inner">
    <li class="wow fadeInUp">
    <div class="title">오늘의 이벤트 차량 조회</div><br>
    <div class="txt">
        - 오늘만 제공하는 특별 견적을 확안하세요.<br><br>
        <span class="blink" >- 수량 마감 시 혜택이 끝날 수 있습니다. </span><br><br>
       
    </div>
</li><br>
        <li class="wow fadeInUp">
            <div class="title">특별 출고 승인 조회</div>
            <div class="txt">
                - <span class="today_date" style="bottom:0;"></span> 의 특별 기준을 적용하여<br><br>
                - 원하시는 차종에 맞는 빠른 출고 승인을 도와드립니다.<br><br>
                <span class="blink" >- 수량 마감 시 혜택이 끝날 수 있습니다. </span><br><br>
               
            </div>
        </li><br>
        <li class="wow fadeInUp">
            <div class="title">최소 월 렌탈료 조회</div><br>
            <div class="txt">
                - 원하는 차종과 조건에 따라 최소 월 렌탈료를 무료로 조회해드립니다.<br><br>
                <span class="blink" >- 최소 금액으로 타실 수 있도록 솔루션을 제공드립니다.</span><br><br>
                - 국내, 수입차 전차종 견적도 추가할인 적용
            </div>
        </li><br>
        <li class="wow fadeInUp">
            <div class="title">구매 조건</div><br>
            <div class="txt">
                - 장기렌트 / 신차리스 모두 가능.<br><br>
                
            </div>
        </li><br>
        <li class="wow fadeInUp" data-wow-delay=".1s">
            <div class="title">신청 혜택 대상 및 신청방법</div>
            <div class="txt">
            <br>
    ...
    <div class="inner">
        <div class="row">
            ...
            <div class="col-md-8 col-12 wow fadeInRight">
                <p>
                    전화 부재시 올바른 혜택을 안내드리지 못하니<br><span>신청시 전화를 꼭 받아주세요.</span>
...
<div class="form-box" id="fm-box">
    <div class="inner">
        <h1 class="form-top-title">전화 상담 신청하기</h1>
