    ...
    <div class="container">
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          ...
          <li ><a class="list-btn" href="../about.html">회사 소개</a></li>
          <li ><a class="list-btn" href="../columns.html">관절 칼럼</a></li>
         ...
         <!-- <li class="drop-down"><a class="list-btn" href="../program.html">제작 과정</a>
          ...
          <li ><a class="imp-btn" href="../column/consulting.html">무료 상담 신청</a></li>
        </ul>
      </nav><!-- .main-nav -->
