$(document).ready(function(){
    $('#send_message').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e11').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLScgV13Ju5HGhy8f7NQ66gBrNzbXkKqdhX88i6JcmZnc63fMOg/formResponse");
...
function hoa(){
    ...
    $(window).scrollTop(0);
    window.location.href="./견적-비싸지는-이유.html";
            ...
            // {
                ...
                // {
                    ...
                    if (agree == true)
                    {
                        $('#send_message').css({transition:"1s"});
                       $('#send_message').prop("disabled", false);
                       $('#send_message').prop("value", "무료 칼럼 신청하기");
