$(document).ready(function(){
    ...
    $('#hidden_iframe12').attr("onload", "dll();");
    $('#hidden_iframe13').attr("onload", "dll();");
    $('#hidden_iframe14').attr("onload", "dll();");
    $('#hidden_iframe15').attr("onload", "dll();");
    $('[name="fm"]').submit();
...
function maxLengthCheck(object){
 ...
 function form_check(){
    ...
    else
    {
        $('#send_message').css({transition:"1s"});
        $('#send_message').prop("disabled", true);
        $('#send_message').prop("value", "자격증 종류를 선택하세요.(최소 1개)");
        $('#send_message').css({background:"#595959"});
        $('#send_message').css({cursor:"default"});        
    }
...
$(function(){
 $('#name,#phone,#position,#id-number,#message,#agree11,[name="lic"]').bind("keyup click change",form_check);
 $('#name,#phone,#position,#id-number,#message,[name="lic"]').bind("keyup click change",form_check1);
 $('#license1,#license2,#license3,#license4').bind("keyup click",fm_add);
