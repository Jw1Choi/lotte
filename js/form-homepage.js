...
<a href="" class="scroll box" style="border-color:#000;text-align:-webkit-center;">
    ...
    <h1 class="form-top-title">애정하는 지인에 솔직하게 말하는 것처럼<br>투명하게 가격 공개해드립니다.</h1>
              ...
              <td>
                  <input type='text' name='entry.576088086' id='phone' class="form-control" placeholder="휴대폰번호" maxlength="11">
                    ...
                    <tr>
                        <th>희망차종</th>
                        <td>
                        <input type='text'  name='entry.1817436242' id='message' class="form-control" placeholder="희망 차종" >
                        </td>
                    </tr>
          ...
          <div class="box_02_1">
              <div style="position:relative;height:150px;overflow:hidden;">
                  <div id="ticker_wrap" style="position: absolute;top:0px;right:0px;width:100%;">
                      ...
                      <tbody>
                          <tr>
                              <td class="tg-0lax"><span class="submit_02">투명견적신청</span></td>
