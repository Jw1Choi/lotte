$(document).ready(function(){
    $('#send_message').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e11').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLSetlL4MgsATI78ejfzmvEYEKgspNNr0zGy_etMOsjCZrw_6lg/formResponse");
...
$(window).scrollTop(0);
window.location.href="./홈페이지-구성-요소.html";
