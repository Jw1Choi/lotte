$(document).ready(function(){
    $('#send_message').click(function(){
        ...
        if(error == false){
           ...
           $('#form_e11').prop("action", "https://docs.google.com/forms/u/0/d/e/1FAIpQLSftkTCFp5I2C8lh4SiAmsLdaGsNFpEo3V_u18d2sHdXC7TTJw/formResponse");
...
function hoa(){
    ...
    $(window).scrollTop(0);
    window.location.href="./고객-확보-기획.html";
